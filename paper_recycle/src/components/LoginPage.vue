    ...
    <div class="container">
        <div class="formBox">
                <form action="" class="form">
                    ...
                    <input type="email" class="inp" id="login__email" />
                    <div class="inputBox">
                        <label for="login__password" class="textLabel">Sifre</label>
                        <input type="password" id="login__password" class="inp" autocomplete="off"/>
                    </div>
                ...
                <question-box context="Hesab yoxdur?" link="Yeni hesab yarat" route="register"></question-box>
            </div> 
        </div>
</template>
